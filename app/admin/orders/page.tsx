...
// Daftar semua pesanan — filter status, search, pagination
// ============================================================
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-gray-50">
              ...
              {(orders ?? []).map((order) => {
                const tpl  = order.templates      as unknown as { name: string; tier: string } | null;
                ...
                return (
                  <tr key={order.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-4 py-3 font-semibold text-[var(--color-primary)] whitespace-nowrap">
